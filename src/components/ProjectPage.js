...
function ProjectPage() {
  ...
  return (
    ...
    <main className="p-6">
        ...
        {Link && (
        <a href={Link} className="text-bone bg-grass font-semibold text-lg px-8 py-2 w-30 rounded-md">Link</a>
      )}
      {Link && (
        <span style={{ margin: '10px' }}></span>
      )}
      <a className="text-bone bg-grass font-semibold text-lg px-8 py-2 w-30 rounded-md">Chat</a>
    </main>
  </div>
  );
}
