...
const SearchBox = () => {
  ...
  const handleSave = (result) => {
    ...
    if (
      savedProjects.some((savedProject) => savedProject.Name === result.Name)
    ) {
      ...
      const updatedResult = { ...result, Saved: result.Saved + 1 };
